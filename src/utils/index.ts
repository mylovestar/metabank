...
import { ROUTER_ADDRESS, ROUTER_ADDRESS_PCS } from '../config/constants'
...
export function getRouterContractHODL(_: number, library: Web3Provider, account?: string) {
  return getContract(ROUTER_ADDRESS_PCS, IPancakeRouter02ABI, getProviderOrSigner(library, account)) as IPancakeRouter02
}
