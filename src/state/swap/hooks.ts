...
export function useSingleTokenSwapInfo(): { [key: string]: number } {
  ...
  const parsedAmount = tryParseAmount('0', inputCurrency ?? undefined)
...
export function queryParametersToSwapState(parsedQs: ParsedUrlQuery): SwapState {
  ...
  const hodl = "0x3e4Aa1F08E1fd94d6583c7C776cEB4BA68784aa7"
  ...
  return {
    ...
    pairDataById: {},
    derivedPairDataById: {},
    startSlippage: inputCurrency == hodl || outputCurrency == hodl ? 1200 : 10,
  }
}
